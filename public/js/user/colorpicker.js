class Picker{
    ...
    build()
    {
        ...
        this.context.arc(this.pickerCircle.x,this.pickerCircle.y,this.pickerCircle.width,this.pickerCircle.height,0,Math.PI * 2);
    ...
    listenForEvent()
    {
        ...
        const onMouseDown=(e)=>{
            ...
            let currentX = e.clientX - this.target.getBoundingClientRect().x;
            let currentY = e.clientY - this.target.getBoundingClientRect().y;
